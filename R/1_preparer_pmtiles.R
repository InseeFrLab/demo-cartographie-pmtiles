...
#fusion des données (dans la table donnees) et de la géographie (dans la table fm)
...
st_write(geo_avec_donnees, chemin_geojson_avec_donnees)
...
## et le package glue facilite l'injection des paramètres et et les sauts de lignes
